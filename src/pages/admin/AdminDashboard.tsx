  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <p className="text-white/40 text-[10px] uppercase font-bold mb-1">O'quvchilar</p>
        ...
        <motion.div 
          ...
          className="glass-panel p-4"
        >
          <p className="text-white/40 text-[10px] uppercase font-bold mb-1">Fanlar</p>
          <p className="text-2xl font-bold text-white">{stats.subjects}</p>
        ...
        <motion.div 
          ...
          className="glass-panel p-4"
        >
          <p className="text-white/40 text-[10px] uppercase font-bold mb-1">To'lovlar</p>
          <p className="text-2xl font-bold text-white">{stats.paidThisMonth}</p>
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-white font-semibold">So'nggi to'lovlar</h2>
        ...
        <div className="space-y-3">
          <div className="group glass-panel-list p-3 flex items-center gap-4">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FEC204] to-[#f59e0b] flex items-center justify-center font-bold text-black border border-white/10">AR</div>
            <div className="flex-1">
              <p className="text-white text-sm font-semibold">Asadbek Rustamov</p>
              <p className="text-white/40 text-[10px]">Matematika • G-24</p>
            </div>
            <div className="text-right">
              <p className="text-white text-sm font-bold">450,000</p>
          ...
          <div className="glass-panel-list p-3 flex items-center gap-4">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FEC204] to-[#f59e0b] flex items-center justify-center font-bold text-black border border-white/10">ZM</div>
            <div className="flex-1">
              <p className="text-white text-sm font-semibold">Zilola Mansurova</p>
              <p className="text-white/40 text-[10px]">English • IELTS 7.0</p>
            </div>
            <div className="text-right">
              <p className="text-white text-sm font-bold">500,000</p>
